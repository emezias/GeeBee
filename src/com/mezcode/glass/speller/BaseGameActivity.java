/*
 * This App was built from the charades sample for the 
...
public abstract class BaseGameActivity extends Activity {
     ...
     */
    protected WordModel createCharadesModel() {
    	int level = PreferenceManager.getDefaultSharedPreferences(this).getInt(ChooseLevelActivity.LEVEL, 0);
        ...
        return new WordModel(allPhrases);
    }
    ...
    protected WordModel getCharadesModel() {
        return mModel;
    }
    ...
    protected boolean score() {
        ...
        if(mModel.markGuessed()) {
        	//cannot advance, end game!
        	return false;
        }
     ...
     */
    String getLevelText() {
    	switch(PreferenceManager.getDefaultSharedPreferences(this).getInt(ChooseLevelActivity.LEVEL, 0)) {
    		case 0:
